...
uses
  ...
  DialogsEx, ComCtrls, ExtCtrls, StdCtrls, Math, StreamTools,
  GraphTools, FormTools, Version;
...
type
  ...
  protected
    ...
    property RatioX: Double read FRatioX;
    property RatioY: Double read FRatioY;
  public
...
procedure TGripForm.AdjustAnchors;
var
  Size: TSize;
  MaxWidth: Integer;
  MaxHeight: Integer;
...
begin
  ...
  Constraints.MinHeight := MaxHeight;
  ...
  begin
    ...
    begin
      ...
      MaxHeight := Max(Control.Top + Control.Height + Round(Size.cy * FRatioY), MaxHeight);
    end;
  end;
...
var
  Point: TPoint;
begin
  if BorderStyle in [bsNone, bsSingle] then
  begin
    inherited;
    Exit;
  end;
...
begin
  if FSizeable then
    with Sender as TPaintBox do
      DrawThemeGrip(Canvas.Handle, ClientRect)
end;
